...
<script setup>
/**
 * Icon — единый примитив для иконок сайта.
 *
 * Использование:
 *   <Icon name="arrow-right" class="w-4 h-4" />
 *   <Icon name="check" class="w-5 h-5 text-gold" :stroke-width="1.5" />
 *
 * Размер задаётся через class (w-N h-N), цвет наследуется (currentColor).
 * Так убираем дублирование одинаковых inline-SVG по всему проекту.
 */
...
const ICONS = {
  ...
  'arrow-long-right': 'M13.5 4.5L21 12m0 0l-7.5 7.5M21 12H3',
  ...
  'check-circle':     'M9 12.75 11.25 15 15 9.75m-3-7.036A11.959 11.959 0 0 1 3.598 6 11.99 11.99 0 0 0 3 9.749c0 5.592 3.824 10.29 9 11.623 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.571-.598-3.751h-.152c-3.196 0-6.1-1.248-8.25-3.285Z',
